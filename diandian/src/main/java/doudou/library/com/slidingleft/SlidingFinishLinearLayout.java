 ...
 */
public class SlidingFinishLinearLayout extends FrameLayout {
    private static final String TAG = SlidingFinishLinearLayout.class.getSimpleName();
    ...
    public SlidingFinishLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingFinishLinearLayout(Context context, AttributeSet attrs, int defStyle) {
