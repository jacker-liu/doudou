package doudou.library.com.gridview;
 ...
 * 下拉刷新\上拉加载更多数据
 * @author liubo
 *         Create at 16/6/27 15:10.
 */
public class AddFooterGridView extends GridView implements AbsListView.OnScrollListener {
     ...
     * 上拉刷新的ListView的回调监听
     */
    private OnMoreDateListener onMoreDataListener;
    ...
    public AddFooterGridView(Context context) {
        super(context);
        initHeaderGridView();
    }

    public AddFooterGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initHeaderGridView();
    }

    public AddFooterGridView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private class FullWidthFixedViewLayout extends FrameLayout {
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            int realLeft = AddFooterGridView.this.getPaddingLeft() + getPaddingLeft();
        ...
        @Override
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int targetWidth = AddFooterGridView.this.getMeasuredWidth()
                    - AddFooterGridView.this.getPaddingLeft()
                    - AddFooterGridView.this.getPaddingRight();
    ...
    private void onMoreRefresh() {
        if (onMoreDataListener != null) {
            onMoreDataListener.OnMoreFresh();
        }
    }
}
