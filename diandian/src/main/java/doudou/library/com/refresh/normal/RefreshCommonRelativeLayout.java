...
/**
 * 上拉刷新下拉加载数据(ListView\GridView\ScrollView)
 * @author liubo
 *         Create at 16/7/11 14:02.
 */
public class RefreshCommonRelativeLayout extends RelativeLayout
{
    // 初始状态
    ...
    public RefreshCommonRelativeLayout(Context context) {
        super(context);
        initView(context);
    }

    public RefreshCommonRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public RefreshCommonRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
            ...
            AsyncTask<Integer, Float, String>
    {
        ...
        protected void onPostExecute(String result)
        {
            ...
            // 刷新操作
            if (mRefreshListener != null)
                mRefreshListener.onRefresh(RefreshCommonRelativeLayout.this);
            hide();
        }
    ...
    private void initView()
    {
        ...
        loadStateTextView = (TextView) loadmoreView
                .findViewById(R.id.load_state_tv);
    ...
    public interface OnRefreshListener
    {
         ...
         * 刷新操作
         */
        void onRefresh(RefreshCommonRelativeLayout pullToRefreshLayout);
    }
    ...
    public interface OnLoadListener{
         ...
         * 加载操作
         */
        void onLoadMore(RefreshCommonRelativeLayout pullToRefreshLayout);
    }
}
