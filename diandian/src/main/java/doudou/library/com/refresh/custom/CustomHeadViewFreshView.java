 ...
 * 自定义下拉的头部(如:美团\天猫..)
 * @author liubo
 * create at 16/7/11.下午3:21
 **/
public class CustomHeadViewFreshView extends RelativeLayout {
    ...
    public CustomHeadViewFreshView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onFinishInflate() {
        ...
        mPullDownView = (ImageView) findViewById(R.id.iv_custom_pull_down);
        mReleaseRefreshingView = (ImageView) findViewById(R.id.iv_custom_release_refreshing);
    }
